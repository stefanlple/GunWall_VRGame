...
{
	{
		...
		NullCheck(L_0);
		VirtualActionInvoker0::Invoke(11 /* System.Void Meta.WitAi.TTS.Utilities.TTSSpeaker::Stop() */, L_0);
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TTSSpeakerInput_SpeakQueuedClick_m20D86A57FF5A9A5A8CE711D313C69B74B252E5F6 (TTSSpeakerInput_tB5AC52F1FF0752F2A719C407055AA6C32E410CE9* __this, const RuntimeMethod* method) 
{
	...
	String_t* V_2 = NULL;
	{
		...
		StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248* L_0 = __this->____queuedText_10;
		V_0 = L_0;
		V_1 = 0;
		goto IL_0024;
	}
...
IL_0024:
	...
	}
	{
		...
		TTSSpeaker_tD5B4F9BF6B84E7144D7DBD08DF599AD60A4CCA9C* L_10 = __this->____speaker_6;
		InputField_tABEA115F23FBD374EBE80D4FAC1D15BD6E37A140* L_11 = __this->____input_5;
		NullCheck(L_11);
		String_t* L_12;
...
IL_006c:
	{
		...
		bool L_15 = __this->____loading_11;
...
IL_00a0:
	{
		...
		bool L_21 = __this->____speaking_12;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TTSSpeakerInput_RefreshButtons_mB9BA66FD8B2A8C75A24A04A4F7EEE0EF001789FE (TTSSpeakerInput_tB5AC52F1FF0752F2A719C407055AA6C32E410CE9* __this, const RuntimeMethod* method) 
{
	...
	Button_t6786514A57F7AFDEE5431112FEA0CAB24F5AE098* G_B3_1 = NULL;
	{
		...
		Button_t6786514A57F7AFDEE5431112FEA0CAB24F5AE098* L_0 = __this->____stopButton_7;
		bool L_1 = __this->____loading_11;
		G_B1_0 = L_0;
		if (L_1)
		{
			G_B2_0 = L_0;
	...
	{
		bool L_2 = __this->____speaking_12;
		G_B3_0 = ((int32_t)(L_2));
		G_B3_1 = G_B1_0;
		goto IL_0018;
	}
