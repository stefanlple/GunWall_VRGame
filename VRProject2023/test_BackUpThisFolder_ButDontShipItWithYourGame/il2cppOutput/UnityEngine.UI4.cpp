...
IL_017a:
	{
		...
		RaycastHit2DU5BU5D_t28739C686586993113318B63C84927FD43063FC7* L_55 = __this->___m_Hits_11;
		int32_t L_56 = V_10;
		NullCheck(L_55);
		float L_57;
		...
		(&V_19)->___worldPosition_7 = L_61;
		RaycastHit2DU5BU5D_t28739C686586993113318B63C84927FD43063FC7* L_62 = __this->___m_Hits_11;
		int32_t L_63 = V_10;
		NullCheck(L_62);
		...
		(&V_19)->___worldNormal_8 = L_65;
		PointerEventData_t9670F3C7D823CCB738A1604C72A1EB90292396FB* L_66 = ___eventData0;
		NullCheck(L_66);
		...
		(&V_19)->___screenPosition_9 = L_67;
		int32_t L_68 = V_2;
		(&V_19)->___displayIndex_10 = L_68;
		List_1_t8292C421BBB00D7661DC07462822936152BAB446* L_69 = ___resultAppendList1;
		NullCheck(L_69);
		int32_t L_70;
...
IL_0230:
	{
		...
		NullCheck(L_73);
		int32_t L_74;
		L_74 = Renderer_get_sortingLayerID_m3D7AE74F1B87099810CF969CB4520C85F9AE5F92(L_73, NULL);
		G_B24_0 = L_74;
		G_B24_1 = G_B23_0;
	}
...
IL_024b:
	{
		...
		NullCheck(L_77);
		int32_t L_78;
		L_78 = Renderer_get_sortingOrder_m4CE7ADEEC8E2F28CC1D10B1D4091A10F8F1583FA(L_77, NULL);
		G_B27_0 = L_78;
		G_B27_1 = G_B26_0;
	}
...
IL_0252:
	{
		...
		List_1_t8292C421BBB00D7661DC07462822936152BAB446* L_80 = ___resultAppendList1;
		RaycastResult_tEC6A7B7CABA99C386F054F01E498AEC426CF8023 L_81 = V_14;
		NullCheck(L_80);
		List_1_Add_mEB6DFEA132B5B7BF540D34177054003185D250E7_inline(L_80, L_81, List_1_Add_mEB6DFEA132B5B7BF540D34177054003185D250E7_RuntimeMethod_var);
		// for (int b = 0, bmax = hitCount; b < bmax; ++b)
		int32_t L_82 = V_10;
...
IL_0035:
	{
		...
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_8 = __this->___m_EventCamera_6;
		V_2 = L_8;
		goto IL_003e;
	}
